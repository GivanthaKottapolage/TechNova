		...
		<Link to={"/overview/" + product.productID} className="w-[300px] h-[400px]  m-4 shadow-2xl cursor-pointer relative hover:[&_.buttons]:opacity-100 hover:[&_.primary-image]:opacity-0">
			...
			<div className="w-full h-[250px]  relative">
				<img
					...
					className="w-full h-full absolute bg-slate-900 object-cover"/>
				<img
					src={product.images[0]}
					className="w-full h-full absolute bg-slate-900 primary-image transition-opacity duration-500 object-cover"/>
			</div>
			...
			<div className="w-full h-[150px] bottom-0 opacity-0 absolute buttons bg-slate-950/90 flex flex-row gap-4 justify-center items-center transition-opacity duration-300">
